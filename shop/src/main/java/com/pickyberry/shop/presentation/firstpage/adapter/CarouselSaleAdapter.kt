...
import com.pickyberry.shop.databinding.ItemSaleBinding

class CarouselSaleAdapter(
    private val carouselDataList: List<Item>,
    private val activity: ShopActivity,
) :
    RecyclerView.Adapter<CarouselSaleAdapter.CarouselItemViewHolder>() {

    class CarouselItemViewHolder(val binding: ItemSaleBinding) :
